 ...
 *
 * This class uses {@link https://sourceforge.net/projects/phpexcelreader/parseXL}
 *
 * @category	PHPExcel
 * @package		PHPExcel_Reader_Excel5
 * @copyright	Copyright (c) 2006 - 2013 PHPExcel (https://www.codeplex.com/PHPExcel)
...
//		$recordData = substr($this->_data, $this->_pos + 4, $length);
	 ...
	 * According to https://support.microsoft.com/kb/147732 there are always at least 15 cell style XF
	 * and 1 cell XF.
